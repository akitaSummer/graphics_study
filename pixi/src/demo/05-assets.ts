...
PIXI.Assets.add("cloud", "/images/cloud/cloud.png");
PIXI.Assets.add("ghost", "/images/ghost/ghost.png");
PIXI.Assets.add("obstacle1", "/images/obstacle1/obstacle1.png");
PIXI.Assets.add("obstacle2", "/images/obstacle2/obstacle2.png");
